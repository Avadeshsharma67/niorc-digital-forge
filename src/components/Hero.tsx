    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-blue-50/30 to-gray-50 overflow-hidden pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-6 sm:mb-8 animate-fade-in leading-tight" style={{ animationDelay: '0.2s' }}>
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed animate-fade-in px-2" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="mb-8 sm:mb-12 animate-fade-in" style={{ animationDelay: '0.45s' }}>
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 sm:p-6 md:p-8 rounded-2xl border border-blue-200 shadow-lg max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-left">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Business Analysis First</h3>
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">ROI-Focused Solutions</h3>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Scalable Architecture</h3>
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Future-Proof Technology</h3>
          ...
          <div className="flex justify-center items-center flex-wrap gap-3 sm:gap-4 mb-8 animate-fade-in" style={{ animationDelay: '0.5s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center animate-fade-in px-4" style={{ animationDelay: '0.8s' }}>
            <Link 
              to="/contact"
              className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold text-sm sm:text-base md:text-lg transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl flex items-center justify-center group relative overflow-hidden"
            >
          ...
          <div className="mt-8 text-center animate-fade-in" style={{ animationDelay: '1s' }}>
            <p className="text-xs sm:text-sm text-gray-500 mb-4">Trusted by 500+ companies worldwide</p>
            <div className="flex justify-center items-center flex-wrap gap-2 sm:gap-6 text-gray-400">
