      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 pt-40">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`text-white space-y-8 ${isVisible ? 'animate-slide-in-left' : 'opacity-0'}`}>
            ...
            {/* Enhanced CTA Buttons with more sophisticated hover effects */}
          ...
          <div className={`relative ${isVisible ? 'animate-slide-in-right' : 'opacity-0'}`}>
            <div className="relative w-full h-96 lg:h-[600px]">
              ...
              <div className="absolute top-12 left-12 w-20 h-20 bg-gradient-to-br from-blue-400/40 to-cyan-400/40 rounded-2xl flex items-center justify-center animate-float delay-300 backdrop-blur-sm border border-blue-400/50">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl shadow-lg"></div>
              </div>
              
              <div className="absolute top-24 right-16 w-16 h-16 bg-gradient-to-br from-purple-400/40 to-blue-400/40 rounded-full animate-float delay-500 backdrop-blur-sm border border-purple-400/50"></div>
              
              <div className="absolute bottom-20 left-16 w-24 h-24 bg-gradient-to-br from-cyan-400/40 to-blue-500/40 rounded-3xl animate-float delay-700 backdrop-blur-sm border border-cyan-400/50">
                <div className="absolute inset-0 bg-shimmer-gradient animate-shimmer"></div>
              </div>
              
              <div className="absolute bottom-12 right-12 w-18 h-18 bg-gradient-to-br from-blue-500/40 to-purple-500/40 rounded-2xl animate-float delay-1000 backdrop-blur-sm border border-blue-500/50"></div>
              
              {/* Enhanced central element with glow animation */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-gradient-to-br from-blue-500 via-cyan-500 to-blue-600 rounded-3xl shadow-2xl shadow-blue-500/30 animate-spin-slow flex items-center justify-center border-4 border-white/20 animate-glow-pulse">
              ...
              <div className="absolute top-16 left-1/2 w-3 h-3 bg-cyan-400 rounded-full animate-float delay-200"></div>
              <div className="absolute bottom-16 left-1/3 w-2 h-2 bg-blue-300 rounded-full animate-float delay-800"></div>
              <div className="absolute top-1/3 right-8 w-4 h-4 bg-purple-400 rounded-full animate-float delay-1200"></div>
              
              {/* Added technology symbol elements */}
              <div className="absolute top-1/4 right-1/4 flex items-center justify-center">
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-400/30 to-cyan-400/30 animate-float backdrop-blur-md flex items-center justify-center border border-blue-400/20">
              ...
              <div className="absolute bottom-1/4 left-1/4 flex items-center justify-center">
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-purple-400/30 to-pink-400/30 animate-float delay-600 backdrop-blur-md flex items-center justify-center border border-purple-400/20">
